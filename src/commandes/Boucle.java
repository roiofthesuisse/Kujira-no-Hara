...
public class Boucle extends Commande implements CommandeEvent, CommandeMenu {
	...
	/**
	 * Au bout de cette fraction de la frame, on considère que le calcul est trop
	 * long
	 */
	...
	/**
	 * La Boucle dépend-elle d'une action du Joueur ? Si oui, elle ne doit pas
	 * échouer par Timeout car ce n'est pas un calcul.
	 * 
	 * @param commandes liste des Commandes de la Page
