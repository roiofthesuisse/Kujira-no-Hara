...
/**
 * Intemp�rie personnalisable dont les particules ont une trajectoire trocho�dale.
...
public class Trochoide extends Meteo {
	 ...
	 * @param vitesseX, vitesseY (en pixels par frame) de la direction g�n�rale des particules
