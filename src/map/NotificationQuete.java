...
public class NotificationQuete {
	...
	private static final String[] ANNONCE_QUETE_PRINCIPALE = new String[] { "Qu�te principale : ", "Main quest: " };
	private static final String[] ANNONCE_QUETE_SECONDAIRE = new String[] { "Qu�te secondaire : ", "Side quest: " };
	private static final String[] ANNONCE_MYSTERE = new String[] { "Myst�re : ", "Mystery: " };
	private static final String[] ANNONCE_MYSTERE_RESOLU = new String[] { "Myst�re r�solu : ", "Mystery solved: " };
	private static final String[] ANNONCE_QUETE_TERMINEE = new String[] { "Qu�te terminee : ", "Completed quest: " };
