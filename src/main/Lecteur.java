 ...
 * Le r�le du lecteur est d'afficher dans la fen�tre la succession des ecrans au cours du temps.
 */
public abstract class Lecteur {	
	 ...
	 * Une frame est une image affich�e a l'ecran pendant une courte dur�e.
	 * A chaque nouveau Lecteur, on repart de 0.
	 */
	public int frameActuelle = 0;
	
	/**
	 * Le r�le d'un Lecteur est de calculer l'ecran a afficher dans la Fen�tre.
	...
	/**
	 * Pr�venir le Lecteur qu'une touche a �t� press�e, pour qu'il en d�duise une action a faire.
	...
	/**
	 * Pr�venir le Lecteur qu'une touche a �t� relach�e, pour qu'il en d�duise une action a faire.
	 * La touche envoy�e ne dois pas �tre nulle !
	...
	/**
	 * D�marrer le Lecteur.
	 * Le Lecteur est allum�, la musique est lue, un ecran est affich� a chaque frame.
